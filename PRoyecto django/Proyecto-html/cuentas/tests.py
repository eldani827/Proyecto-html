"""Pruebas para la app 'cuentas'.

Sugerencias de pruebas a implementar:
- Envío de código (POST a `olvide_password`) y comprobación de respuesta.
- Verificación de código correcto/incorrecto/expirado (`verificar_codigo`).
