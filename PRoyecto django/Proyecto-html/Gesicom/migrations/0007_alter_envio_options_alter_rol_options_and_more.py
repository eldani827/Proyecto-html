# Generated by Django 5.0 on 2026-02-24 11:48
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Gesicom', '0006_alter_envio_options_alter_instructorprofile_options_and_more'),
    ...
    operations = [
        migrations.AlterModelOptions(
            name='envio',
            options={'ordering': ['-fecha_envio'], 'verbose_name': 'Envío de Evidencia', 'verbose_name_plural': 'Envíos de Evidencias'},
        ),
        migrations.AlterModelOptions(
            name='rol',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='Gesicom.rol')),
